...
export function coerceThemeId(value: string | null | undefined, fallback: ThemeId = 'default'): ThemeId {
...
export function coerceColorMode(value: string | null | undefined, fallback: ColorMode = 'dark'): ColorMode {
    if (!value) return fallback;
