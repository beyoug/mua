...
<script lang="ts">
    ...
    $effect(() => {
        // 简单单向同步初始化
        if (!btTrackers && $appSettings.btTrackers)
            btTrackers = $appSettings.btTrackers;
    });
        ...
        <div class="setting-list">
            <div class="setting-item">
                <div class="setting-info">
                        ...
                        <div class="setting-name">
                            ...
                            <div class="tooltip-trigger">
                                ...
                                <span class="tooltip-text"
                                    >允许从 DHT 网络获取节点，有助于无 Tracker
                                    下载。</span
                                >
                            </div>
                        </div>
                        <div
                            class="port-input-inline"
                            class:disabled={!enableDht}
                        >
                    ...
                    {#if isDhtPortChanged}
                        <div
                            class="inline-restart-hint"
                            transition:fade={{ duration: 150 }}
                        >
                            <RefreshCw size={12} />
                            <span>端口已改，需重启生效</span>
                            <button
                                class="text-relaunch-btn"
                                onclick={() => relaunch()}>立即重启</button
                            >
                        </div>
                    {/if}
                </div>
            ...
            <div class="setting-item">
                <div class="setting-info">
                    <div class="setting-header-row">
                        ...
                        <div
                            class="port-input-inline"
                            class:disabled={!enablePeerExchange}
                        >
                            <span class="port-label">端口</span>
                            <input
                                type="text"
                ...
                <div class="setting-control">
                    <label class="switch">
                        <input
                            type="checkbox"
                            bind:checked={enablePeerExchange}
                            onchange={handleSave}
                        />
                        <span class="slider"></span>
                    </label>
                    ...
                    >
                        <div class="preview-header">
                            ...
                            <div class="preview-btns">
                                <button
                                    class="mini-btn append"
                                    onclick={appendTrackers}
                                >
                                    <Plus size={12} />
                                    追加
                                </button>
                                <button
                                    ...
                                    onclick={() => (showTrackerPreview = false)}
                                >
                                    取消
                                </button>
                            </div>
